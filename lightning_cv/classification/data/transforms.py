...
__all__ = ['ClassificationTransformCatalog', 'ImageClassificationTransforms', 'TorchvisionTransform',
           'AlbumentationsTransform', 'ImagenetNoAugmentTransform', 'GenericImageTransform', 'AugTransforms',
           'TransformOutput', 'create_transform']
...
ClassificationTransformCatalog.__doc__ = "Registery of ImageClassification Transformations"
...
class ImagenetNoAugmentTransform(TorchvisionTransform):
    ...
    def __init__(self, img_size:Union[Tuple,int], crop_pct:float=DEFAULT_CROP_PCT, interpolation:str='bilinear',
                 mean:Union[Tuple,List]=IMAGENET_DEFAULT_MEAN, std:Union[Tuple,List]=IMAGENET_DEFAULT_STD,):
...
class GenericImageTransform(TorchvisionTransform):
    ...
    def __init__(self, img_size: Union[Tuple, int], interpolation: str = 'random', scale: Optional[Union[List, Tuple]] = None,
                 ratio: Optional[Union[List, Tuple]] = None, hflip: float = 0.5, vflip: float = 0.5,
                 color_jitter: Optional[Union[List, Tuple, float]] = 0.4, re_prob: float = 0., re_mode: str = 'const',
                 re_count: int = 1, re_num_splits: int = 0, mean: Union[Tuple, List] = IMAGENET_DEFAULT_MEAN,
...
class AugTransforms(AlbumentationsTransform):
    ...
    * `p_shift`, `p_lighting`, `p_cutout` probablities for `ShiftScaleRotate`, `HueSaturationValue` & `CutOut`.
    ...
    def __init__(self, img_size: int, scale: Optional[Union[List, Tuple]] = None, ratio: Optional[Union[List, Tuple]] = None,
                 interpolation: int = 1, do_flip: bool = True, flip_vert: bool = False, shift_limit: float = 0.0625,
                 scale_limit: float = 0.1, max_rotate: float = 45, border_mode: int = 4, max_lighting: Optional[Union[List, Tuple, float]] = 0.4,
                 p_shift: float = 0.5, p_lighting: float = 0.75, p_cutout: Optional[float] = 0.5,
                 mean: Union[Tuple, List] = IMAGENET_DEFAULT_MEAN, std: Union[Tuple, List] = IMAGENET_DEFAULT_STD):
...
def create_transform(cfg: DictConfig) -> Dict[str, TransformOutput]:
    ...
    transform_cls: ImageClassificationTransforms = ClassificationTransformCatalog.get(cfg.NAME)
