...
__all__ = ['GeneralClassifier', 'FastaiClassifier', 'CNN_CLASSIFIER_REGISTRY', 'create_classifier_head']
...
# Cell
CNN_CLASSIFIER_REGISTRY = Registry("CNN_Classifiers")
CNN_CLASSIFIER_REGISTRY.register(FastaiClassifier)
CNN_CLASSIFIER_REGISTRY.register(GeneralClassifier)
...
def create_classifier_head(cfg: DictConfig):
    ...
    classifier = CNN_CLASSIFIER_REGISTRY.get(cfg.MODEL.CLASSIFIER.NAME)
    classifier = classifier.from_config(cfg.MODEL.CLASSIFIER.ARGUMENTS)
    return classifier